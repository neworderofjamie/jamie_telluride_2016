...
with model:
    ...
    nengo.Connection(ir_input_ensemble[1], left_ensemble.neurons, transform=[[-2.5]] * 100)
    nengo.Connection(ir_input_ensemble[0], right_ensemble.neurons, transform=[[-2.5]] * 100)
